            ...
            [
                ...
                'lessons' => [
                    [
                        ...
                        'xp' => 0,
                        'type' => 'reading',
                        'content' => 'Programar es darle instrucciones claras a una computadora. Una instruccion es una orden pequena, como mostrar un mensaje, guardar un dato o tomar una decision. En este nivel no necesitas escribir codigo todavia: vas a ordenar bloques visuales para entender la logica paso a paso. Piensa en cada bloque como una pieza de una receta: primero empieza el programa, despues agregas la accion que quieres que ocurra.',
                        'objective' => 'Reconocer que un programa es una secuencia de instrucciones.',
                        'instruction' => 'Lee la explicacion. Cuando entiendas que los programas se construyen ordenando instrucciones, continua con el primer ejercicio de bloques.',
